 ...
 * celebration (see that hook) — never on the reverse (unselecting), which
 * is a plain unfill. Pin Icon Button shares the exact same hook, so both
 * controls run on identical timing by construction, not by convention.
 *

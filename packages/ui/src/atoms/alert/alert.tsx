/**
 * Fabely Alert atom — wraps the upstream shadcn Alert primitive
 ...
 * `Flip Icon` boolean, and a `Show Button` slot. This atom implements all
 ...
 *   is unconditional there), but this atom still derives visibility from
 ...
 * atom's original (Neutral-only) revision for why the layout itself

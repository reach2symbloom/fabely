...
Per `docs/DESIGN.md`: molecules compose atoms rather than duplicating their implementation, and should consume semantic tokens once a reusable role emerges rather than being invented prematurely.

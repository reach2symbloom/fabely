...
Foundations-matched (no dedicated Figma set): [Hover Card](./hover-card/README.md) (floating panel tokens); [Marker](./marker/README.md) (conversation system notes); [Menubar](./menubar/README.md) (bar + Dropdown Menu composition); [Message](./message/README.md) (conversation row around Bubble).

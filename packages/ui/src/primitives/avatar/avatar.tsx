/**
 * Fabely Avatar primitive — wraps the upstream shadcn Avatar primitive
 ...
 * selection this primitive was built from), so the 28% ratio itself is an
 ...
 * reference), adapted to this primitive's own structure rather than reused
